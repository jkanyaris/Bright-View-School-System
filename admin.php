...
if(mysql_num_rows($run)>0){
 ...
 echo"<script>window.open('admin.php?error=wrong username or password ','_self')</script>";
...
<li class="no-sub"><a class="top-heading" href="index.php">Home</a></li>
 <li class="no-sub"><a class="top-heading" href="stafflogin.php">Staff login</a></li>
	...
	<li class="no-sub"><a class="top-heading" href="accountactivation.php">Account Activation</a></li>
...
<legend align="">
<font color="brown" size="4.5" >Admin Login</font>
</legend><br/>


<input style="border-radius:4px; width:200px; height:22px;"type="text" name="username" placeholder="Enter username" align="absmiddle"/><br/><br/>
...
<input type="submit" style="width:80px;" name="adminlogin" value="Login">
...
<div id="footer">
<center><footer>Bright View Schools Copyright 2015.</footer></center>
</div>
</div>
</body>
</html>