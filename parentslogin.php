...
$pass=$_POST['password'];
$sql="select * from parents where username='$username' and pass='$pass'";
$run=mysql_query($sql);
...
$_SESSION['parents']=$name;
header('location:parents.php');

}
else{
echo"<script>window.open('parentslogin.php?error=Wrong password or username','_self')</script>";
...
<legend>
<font color="brown" size="4.5" >Parents Login</font>
</legend><br/>
