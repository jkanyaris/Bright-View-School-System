...
if(isset($_POST['clearcube'])){
header('location: clearcube.php');
...
<nav>
 ...
 <legend ><font size="5" color="brown">Cube clearance form</font></legend>
 <form action="cubeclearanceform.php" method="post">
...
$obj=mysql_fetch_object($exe);
 ...
 <tr><td><b><i><font color="brown">Class</font></i></b></td><td><?php echo $obj->classname; ?></td></tr>
 <tr><td><b><i><font color="brown">Year</font></i></b></td><td><?php echo $obj->year; ?></td></tr>
 
 <tr><td><b><i><font color="brown">House</font></i></b></td><td><?php
...
echo '</td></tr>
 ...
 <input type="submit" name="clearcube" value="Clear the above student" style="border-radius:5px; margin-top:20px;"/>
 </form>
 </fieldset>
 </section>
 <?php 
